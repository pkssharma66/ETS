...
<?php //echo "<pre>";print_r($admintaskrow);exit;?>
<section id="main-content">
     <section class="wrapper main-wrapper "> 
        ...
        <?php } ?>   
         <div>
         	<h1>Admin Task asign Details</h1>
         </div> 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <select class="form-control" name="enqnoid" id="enqnoid" >
                                            ...
                                            <option value="<?php echo $admintaskrow['enq_id'];?>"><?php echo $admintaskrow['enq_id'];?></option>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <input type="Date" name="rfqdate" id="rfqdate" class="form-control" value="<?php echo $admintaskrow['rfq_date'];?>" readonly>
                                    </div>
                                </div>
                             </div> 
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <input type="Date" name="rfqsubmitedate" id="rfqsubmitedate" class="form-control" value="<?php echo $admintaskrow['rfq_date'];?>" readonly>
                                    </div>
                                </div>
                            </div> 
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" id="po">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <input type="Date" name="porecvdate" id="porecvdate" class="form-control" value="<?php echo $admintaskrow['rfq_date'];?>" readonly>
                                    </div>
                                </div>
                            </div> 
                        </div>
...
<script>
    ...
    $("#cancel").on('click',function(){
        window.location.href="<?php echo base_url();?>DashboardCtrl/assignedtasklist";
        return false;
    });
