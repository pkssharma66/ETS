                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <input type="text" name="compname" id="compname" value="<?php echo $wondata['comp_name'];?>" class="form-control" placeholder="Enter Company Name" readonly>
                                    </div>
                                </div>
                            </div> 
                        </div>
                        ...
                        <div class="col-6" id="po">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <input type="Date" name="porecvdate" id="porecvdate" value="<?php echo $wondata['po_rec_date'];?>" class="form-control" required>
                                    </div>
                                </div>
                            </div> 
                        </div>
                        <div class="col-6" id="pos">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <input type="Date" name="projstartdate" id="projstartdate" value="<?php echo $wondata['project_start_date'];?>" class="form-control" required>
                                    </div>
                                </div>
                        ...
                        <div class="col-6" id="poe">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <input type="Date" name="projenddate" id="projenddate" value="<?php echo $wondata['project_end_date'];?>" class="form-control" required>
                                    </div>
                                </div>
